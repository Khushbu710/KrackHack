...
There is authRoutes wriiten in a line in api.js. Also the login and regitration path api have not been mentioned in backend and we made changes but forgot to add them in final submission kindly check. 
